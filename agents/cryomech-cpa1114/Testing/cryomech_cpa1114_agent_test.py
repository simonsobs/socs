#Added test feature: Randomly (80% of the time) it will fake a bad string output
...
class PTC:
    ...
    def breakdownReplyData(self, rawdata):
        ...
        #TEST FEATURE: randomly swap in a bad string
        if random.random() < 0.8:
            rawdata = "TEST: This is a bad string" 
