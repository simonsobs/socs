...
class MagpieAgent:
    ...
    def set_monitored_channels(self, session, params):
        """set_monitored_channels(chans, sample_rate=10)
        ...
        chan_info : list
            ...
            Entries of this list can be:
             - ints: This will be interpreted as the readout-channel to
               monitor. The feed-name will be set to "r<chan_no>".
             - tuples of length 2: Here the first element will be the readout
               chan to monitor, and the second value will be the feed name to
    ...
    def _process_monitored_chans(self, times, data):
        """
        Downsamples data for monitored channels and publishes tods to grafana
        feed.
        """
