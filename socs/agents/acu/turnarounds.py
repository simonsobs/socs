...
def gen_free_form_stop(t0, a0, v0, az0, el0, stoptime, az_flag, el_flag, point_group_batch, step_time=0.1):
    ...
    Args:
        ...
        a0 (float): The initial azimiuth acceleration of the stop. May not be 0 if stop is initiated in a turnaround.
...
def _gen_standard_turnaround(v0, turntime, step_time=0.1):
    """
