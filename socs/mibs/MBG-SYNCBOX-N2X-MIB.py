...
if mibBuilder.loadTexts: mbgSyncboxN2X.setLastUpdated('201309030000Z')
if mibBuilder.loadTexts: mbgSyncboxN2X.setOrganization('www.meinberg.de')
...
if mibBuilder.loadTexts: mbgSyncboxN2XNtpSyncStatus.setStatus('current')
mbgSyncboxN2XNtpSystemPeer = MibScalar((1, 3, 6, 1, 4, 1, 5597, 40, 1, 2), DisplayString()).setMaxAccess("readonly")
if mibBuilder.loadTexts: mbgSyncboxN2XNtpSystemPeer.setStatus('current')
mbgSyncboxN2XNtpStratum = MibScalar((1, 3, 6, 1, 4, 1, 5597, 40, 1, 3), Unsigned32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: mbgSyncboxN2XNtpStratum.setStatus('current')
mbgSyncboxN2XNtpRefSourceTable = MibTable((1, 3, 6, 1, 4, 1, 5597, 40, 1, 4), )
if mibBuilder.loadTexts: mbgSyncboxN2XNtpRefSourceTable.setStatus('current')
...
if mibBuilder.loadTexts: mbgSyncboxN2XNtpRefSourceTableEntry.setStatus('current')
...
if mibBuilder.loadTexts: mbgSyncboxN2XPtpProfile.setStatus('current')
...
if mibBuilder.loadTexts: mbgSyncboxN2XPtpNwProt.setStatus('current')
...
if mibBuilder.loadTexts: mbgSyncboxN2XPtpPortState.setStatus('current')
...
if mibBuilder.loadTexts: mbgSyncboxN2XPtpDelayMechanism.setStatus('current')
mbgSyncboxN2XPtpDelayRequestInterval = MibScalar((1, 3, 6, 1, 4, 1, 5597, 40, 2, 5), Integer32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: mbgSyncboxN2XPtpDelayRequestInterval.setStatus('current')
...
if mibBuilder.loadTexts: mbgSyncboxN2XPtpGrandmasterTimesource.setStatus('current')
mbgSyncboxN2XPtpGrandmasterPriority1 = MibScalar((1, 3, 6, 1, 4, 1, 5597, 40, 2, 11), Unsigned32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: mbgSyncboxN2XPtpGrandmasterPriority1.setStatus('current')
mbgSyncboxN2XPtpGrandmasterClockClass = MibScalar((1, 3, 6, 1, 4, 1, 5597, 40, 2, 12), Unsigned32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: mbgSyncboxN2XPtpGrandmasterClockClass.setStatus('current')
...
if mibBuilder.loadTexts: mbgSyncboxN2XOutputsTableEntry.setStatus('current')
...
if mibBuilder.loadTexts: mbgSyncboxN2XOutputIndex.setStatus('current')
...
if mibBuilder.loadTexts: mbgSyncboxN2XOutputMode.setStatus('current')
mbgSyncboxN2XSerialString = MibScalar((1, 3, 6, 1, 4, 1, 5597, 40, 3, 2), DisplayString()).setMaxAccess("readonly")
if mibBuilder.loadTexts: mbgSyncboxN2XSerialString.setStatus('current')
